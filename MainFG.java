...
public class MainFG {
    public static void main(String[] args) {
        ...
        System.out.println("Elige la figura Geómetrica para calcular el área");
        ...
        FigurasGeometricas pruebaFigura1 = new FigurasGeometricas(ladoCuadrado, baseTriangulo,
         alturaTriangulo, radioCirculo, opcion);
